...
public class MenuActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_perfil) {
            ...
            /*Intent intent= new Intent(this,MenumensageriaActivity.class);
            startActivity(intent);*/
            //fragmentManager.beginTransaction().replace(R.id.contenedor,new ContactosFragment()).commit();}
        else if (id == R.id.nav_chatbot) {
            fragmentManager.beginTransaction().replace(R.id.contenedor,new ChatBotFragment()).commit();
        } /*else if (id == R.id.nav_camara) {
            fragmentManager.beginTransaction().replace(R.id.contenedor,new CamaraFragment()).commit();
